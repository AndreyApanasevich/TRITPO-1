...
Приложение должно работать в Telegram клиенте версии не ниже 6.0.0. В приложении будет использоваться Telegram Bot API версии 6.2. Написано на языка Python 3.10 и базу данных SQLite версии 3.39.4.
