...
Приложение работает в любом Telegram клиенте, но более старые версии лишены поддержки кнопок. В приложении будет использоваться Telegram Bot API. Написано на языка Python и базу данных SQLite.
